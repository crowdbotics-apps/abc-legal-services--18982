"""abc_legal_services__18982 URL Configuration
...
admin.site.site_header = "ABC Legal Services Mobile"
admin.site.site_title = "ABC Legal Services Mobile Admin Portal"
admin.site.index_title = "ABC Legal Services Mobile Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="ABC Legal Services Mobile API",
        default_version="v1",
        description="API documentation for ABC Legal Services Mobile App",
    ),
    public=True,
